...
const resourceSections = [
  {
    ...
    items: [
      {
        title: "SaintSalGPT 4.1 API",
        description: "Complete API documentation for our flagship AI model",
        status: "Available",
      },
      {
        title: "Azure Cognitive Services Integration",
        description: "Seamless integration with Microsoft Azure services",
        status: "Available",
      },
      {
        title: "SDK Libraries",
        description: "JavaScript, Python, and Node.js SDK packages",
        status: "Available",
      },
      {
        title: "Webhook Configuration",
        description: "Real-time event notifications and data sync",
        status: "Available",
      },
      {
        title: "Authentication & Security",
        description: "OAuth 2.0, API keys, and enterprise SSO setup",
        status: "Available",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description:
          "Comprehensive data protection and user privacy guidelines",
        status: "Current",
      },
      {
      ...
      },
      {
        ...
        description:
          "SOC 2 Type II, ISO 27001, and enterprise security standards",
        status: "Certified",
      },
      {
        title: "Data Retention Policy",
        description: "Clear guidelines on data storage, backup, and deletion",
        status: "Current",
      },
      {
        title: "Incident Response Plan",
        description: "Security breach notification and response procedures",
        status: "Current",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Uptime guarantees and performance commitments",
        status: "Enterprise",
      },
      {
        title: "Intellectual Property",
        description: "Copyright, trademark, and IP usage policies",
        status: "Protected",
      },
      {
        title: "Licensing Agreement",
        description: "Software licensing terms for commercial use",
        status: "Available",
      },
      {
        title: "Compliance Framework",
        description:
          "Regulatory compliance for finance, healthcare, and government",
        status: "Certified",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: "Step-by-step implementation guides and sample code",
        status: "Updated",
      },
      {
      ...
      },
      {
        ...
        description: "API usage limits and enterprise scaling options",
        status: "Flexible",
      },
      {
        title: "Monitoring & Analytics",
        description: "Usage dashboards and performance monitoring tools",
        status: "Real-time",
      },
      {
        title: "Community Forum",
        description: "Developer community support and knowledge sharing",
        status: "Active",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Branded AI platform deployment for partners",
        status: "Available",
      },
      {
        title: "Dedicated Infrastructure",
        description: "Private cloud deployment and dedicated resources",
        status: "Enterprise",
      },
      {
        title: "Professional Services",
        description: "Implementation support and consulting services",
        status: "Available",
      },
      {
        title: "Training & Certification",
        description: "Team training and AI certification programs",
        status: "Available",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: "24/7 enterprise support and troubleshooting",
        status: "Available",
      },
      {
      ...
      },
      {
        ...
        description: "Sales, support, and partnership contact details",
        status: "Current",
      },
      {
        title: "Feedback & Suggestions",
        description: "Product feedback and feature request submission",
        status: "Open",
      },
    ],
  },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto mb-8">
            Comprehensive documentation, legal terms, API integration guides,
            and enterprise resources. Everything you need to build, deploy, and
            scale with SaintVisionAI.
          </p>
        ...
        <div className="text-center mt-20 p-8 rounded-3xl bg-gradient-to-br from-muted/10 to-muted/5 border border-border/30">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Our enterprise team is ready to help with custom integrations,
      ...
      <div className="relative z-10 border-t border-border/30 p-6 mt-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center text-xs text-muted-foreground/60">
            © 2024 SaintVisionAI. All rights reserved. | SOC 2 Type II
