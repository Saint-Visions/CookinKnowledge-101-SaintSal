...
export const builderConfig = {
  ...
  fallbacks: {
    heroSection: {
      ...
      description:
        "Revolutionizing industries through patented HACP™ technology, faith-guided innovation, and AI solutions that change lives.",
...
export function getContentFallback(modelName: string): any {
  return (
    builderConfig.fallbacks[
      modelName as keyof typeof builderConfig.fallbacks
    ] || null
  );
}
